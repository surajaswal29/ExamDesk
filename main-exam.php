...
?> <!--file that contains all external code -->
    ...
    <div class="container-fluid vh-100 student-main-wrap">
        ...
        <!-- top header end -->
        <?php
            $question_select="SELECT * FROM exam WHERE exam_id='{$_GET['exam_code']}' LIMIT $question_per_card OFFSET $offset";
            ...
            if($row_count>0){
                ...
                $check_query="SELECT * FROM st_answer WHERE exam_code='{$_GET['exam_code']}'and student_reg_id='{$_SESSION['reg_id']}' and question='{$question_data['Question']}'";
                    ...
                    <div class="exam-box-gh">
                        <div class="question-box">
                                ...
                                <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-1 absolute-center">
                                                    <label class="checkbox-label">
                                                        <input type="checkbox" name="option1" value="<?php echo $question_data['option1']; ?>">
                                        ...
                                        <div class="col-md-12 mt-1">
                                            <div class="row">
                                                <div class="col-md-1 absolute-center">
                                                    <label class="checkbox-label">
                                                        <input type="checkbox" name="option2" value="<?php echo $question_data['option2']; ?>">
                                        ...
                                        <div class="col-md-12 mt-1">
                                            <div class="row">
                                                <div class="col-md-1 absolute-center">
                                                    <label class="checkbox-label">
                                                        <input type="checkbox" name="option3" value="<?php echo $question_data['option3']; ?>">
                                        ...
                                        <div class="col-md-12 mt-1">
                                            <div class="row">
                                                <div class="col-md-1 absolute-center">
                                                    <label class="checkbox-label">
                                                        <input type="checkbox" name="option4" value="<?php echo $question_data['option4']; ?>">
                            ...
                            if(isset($_POST['next'])){
                                ...
                                $insert_ques="INSERT INTO st_answer(student_reg_id,exam_code,question,answer,c_answer) VALUES('{$_SESSION['reg_id']}','{$_GET['exam_code']}','{$question_data["Question"]}','$option','{$question_data["correct_option"]}')";
                                $insert_result=mysqli_query($con,$insert_ques);

                                if($insert_ques){
                                    redirect("main-exam.php?exam_code=".$_GET['exam_code']."&exam_type=".$_GET['exam_type']."&question_no=".$q_no);
                                }
                            }
                            ?>
                        </div>
                                        ...
                                        <div class="exam-box-gh pg-x">
                                            <div class="question-box">
                                                <div class="row">
                                                    ...
                                                    <?php
                                                        // total Question
                                                        $exam_submitted="SELECT * FROM st_answer WHERE exam_code='{$_GET['exam_code']}'and student_reg_id='{$_SESSION['reg_id']}'";
                                                        ...
                                                        $ques_answered_query="SELECT * FROM st_answer WHERE exam_code='{$_GET['exam_code']}'AND student_reg_id='{$_SESSION['reg_id']}' AND answer!='0'";
                                                        $ques_answered_res=mysqli_query($con,$ques_answered_query);

                                                        $ques_answered=mysqli_num_rows($ques_answered_res);

                                                        // leaved question
                                                        $leaved_ques_query="SELECT * FROM st_answer WHERE exam_code='{$_GET['exam_code']}'AND student_reg_id='{$_SESSION['reg_id']}' AND answer='0'";
                                                        $leaved_ques_res=mysqli_query($con,$leaved_ques_query);

                                                        $leaved_ques=mysqli_num_rows($leaved_ques_res);

                                                        // correct answer
                                                        $count_correct="SELECT * FROM `st_answer` WHERE exam_code='{$_GET['exam_code']}'AND student_reg_id='{$_SESSION['reg_id']}' AND answer=c_answer";
                                                        ...
                                                        // wrong answers
                                                        $count_correct1="SELECT * FROM `st_answer` WHERE exam_code='{$_GET['exam_code']}'AND student_reg_id='{$_SESSION['reg_id']}' AND answer!=c_answer";
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $total_marks_scored=$count_no*5 ."/". $total_question*5 ?></td>
                                                        </tr>    
                                                        </table>
                                                    </div>
